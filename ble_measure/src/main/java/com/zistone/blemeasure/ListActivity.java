...
import com.zistone.libble.controls.BleListAdapter;
import com.zistone.libble.pojo.MyBluetoothDevice;
import com.zistone.libble.util.MyBleScanListener;
import com.zistone.libble.util.MyBleUtil;
import com.zistone.libble.util.MyConvertUtil;
import com.zistone.libble.util.MyDeviceFilterShared;
...
public class ListActivity extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemClickListener, TextWatcher,
    ...
    private void BeginScan() {
        ...
        if (MyBleUtil.StartScanLe() == 1) {
            ...
            Toast.makeText(this, "请确认系统蓝牙是否开启", Toast.LENGTH_SHORT).show();
        }
    }
