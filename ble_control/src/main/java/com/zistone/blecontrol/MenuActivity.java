...
import com.zistone.libble.util.MyInstallAPKUtil;
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_ota_menu:
                ...
                if (MyInstallAPKUtil.CheckInstalled(this, "com.ambiqmicro.android.amota")) {
                    ...
                    MyProgressDialogUtil.ShowConfirm(this, "好的", "不了", "提示", "未安装OTA_ZM301，无法使用该功能！是否安装？", true,
                            new MyProgressDialogUtil.ConfirmListener() {
                        @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyBleUtil.SetConnectListener(new MyBleConnectListener() {
            ...
            public void OnConnecting() {
                Log.i(TAG, "正在建立连接...");
                MyProgressDialogUtil.ShowWaittingDialog(MenuActivity.this, true, null, "正在连接...\n如长时间未连\n接请返回重试");
            }
