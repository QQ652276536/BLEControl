...
public class LocationActivity extends AppCompatActivity implements View.OnClickListener, BaiduMap.OnMapClickListener,
            ...
            switch (message.what) {
                ...
                case RECEIVE_LOCATION: {
                    ...
                    if (null != _locationActivity._baiduMap) {
                        ...
                        MarkerOptions markerOptions = new MarkerOptions().position(_locationActivity._latLng).icon(BitmapDescriptorFactory.fromResource(R.drawable.icon_mark));
                        //标记添加至地图中
    ...
    public void onMapLoaded() {
        ...
        //设置标记的位置和图标
        MarkerOptions markerOptions = new MarkerOptions().position(_latLng).icon(BitmapDescriptorFactory.fromResource(R.drawable.icon_mark));
        //标记添加至地图中
