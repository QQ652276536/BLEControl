 ...
 * 修改基站参数
 */
public class ShowHideSettingDialogFragment extends DialogFragment implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    private static final String TAG = "ShowHideSettingDialogFragment";
    ...
    public static ShowHideSettingDialogFragment NewInstance(DialogFragmentListener listener) {
        _dialogFragmentListener = listener;
        ShowHideSettingDialogFragment fragment = new ShowHideSettingDialogFragment();
        return fragment;
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn1_ok:
                ...
                MyDeviceFilterShared.SetIsShowDeviceAndFunc(_context, objectArray);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Object[] objectArray = MyDeviceFilterShared.GetIsShowDeviceAndFunc(_context);
