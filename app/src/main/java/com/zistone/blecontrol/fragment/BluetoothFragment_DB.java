...
public class BluetoothFragment_DB extends Fragment implements View.OnClickListener, MyOkHttpUtil.MyOkHttpListener, Spinner.OnItemSelectedListener
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        _txt1 = _view.findViewById(R.id.txt1_db);
        _txt2 = _view.findViewById(R.id.txt2_db);
        _txt3 = _view.findViewById(R.id.txt3_db);
        _txt3.setText(String.valueOf(_rssi));
        _txt4 = _view.findViewById(R.id.txt4_db);
        _txt5 = _view.findViewById(R.id.txt5_db);
        _txt7 = _view.findViewById(R.id.txt7_db);
        _txt8 = _view.findViewById(R.id.txt8_db);
